...
- [x] Internet play v1 (round 13: UDP lobby sidecar, region table + widen order, live ping + region cycle in the hero-select ONLINE panel, published-server addressing; NAT traversal/relay still open)
