...
- [ ] Role/sub-role passive registry (data-only passives)
- [ ] Weapon framework (hitscan + projectile classes, heat/charge tables, headshot multipliers)
- [ ] Heroes #2–#6 (2 Assault, 1 Tank, 2 Support/Utility, 1 Controller per directive §6) — each with distinct movement/combat identity
...
- [ ] Roster tests: TTK/DPS bands, CC-lock check, ult-charge pacing
